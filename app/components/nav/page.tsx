        ...
        <div className="bg-lime-300/90 h-5">
            ...
            <div className="flex absolute top-0 left-1 bg-lime-300/90">
                {isMenuOpen ? (<ul className={`transition-all duration-300 ease-in-out flex-row space-y-2`}>
                    ...
                    <li className="basis-1/4"><Link href={('/camps')}><button onClick={toggleMenu}>Camps</button></Link></li>
                    <li className="basis-1/4"><Link href={('/reviews')}><button onClick={toggleMenu}>Reviews</button></Link></li>
                </ul>) : (
