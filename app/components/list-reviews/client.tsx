...
export default function ListReviews({ reviews, isLoading, error }: ListReviewsProps) {
    ...
    return (
        <div className="max-w-screen-xl mx-auto p-2 bg-teal-300/50 w-screen object-contain border-solid rounded">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 p-4 max-w-6xl mx-auto">
                {reviews?.map((item) => (
                    <div key={item.id} className="bg-teal-200 rounded-lg shadow-lg overflow-hidden">
                        <div className="p-6">
