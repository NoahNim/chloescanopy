export default function Pricing() {
    return (
        <div className="bg-lime-300/90 border-solid rounded p-4 flex flex-col m-3">
            ...
            <h2 className="text-center font-bold text-xl"><b>Group Class 3-4 students</b></h2>
            <ul className="list-none p-2 text-center">
                <li><b>Single Class:</b> $55</li>
                <li><b>Six Classes:</b> $270</li>
                <li><b>Make Up Class:</b> $15</li>
            </ul>
            <h2 className="text-center font-bold text-xl"><b>Private Lessons</b></h2>
            <ul className="list-none p-2 text-center">
